...
//    public static ModConfigSpec.BooleanValue FIX_209;
    ...
    public static ModConfigSpec.IntValue STRUCTURE_PURITY;
...
//                .define("Fix #209", false);
        ...
        STRUCTURE_PURITY = BUILDER
                .comment("The purity of water cauldrons when generated by a structure (Witch Huts, etc)")
                .defineInRange("Structure Purity", 2, 0, 3);
